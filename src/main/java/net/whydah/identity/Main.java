...
public class Main {
    ...
    public void startHttpServer() throws Exception {
        ...
        servletHandler.addInitParameter("com.sun.jersey.config.property.packages",
                "net.whydah.identity.user.resource, net.whydah.identity.user.authentication, net.whydah.identity.application.resource, net.whydah.identity.application.authentication");
