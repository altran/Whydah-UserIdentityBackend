...
import net.whydah.iam.service.config.ImportModule;
import net.whydah.iam.service.config.UserIdentityBackendModule;
...
import net.whydah.iam.service.security.SecurityFilter;
...
//        roleMappingImporter.importRoleMapping(roleMappingImportSource);
    ...
    public void startHttpServer() throws Exception {
        ...
        servletHandler.addInitParameter("com.sun.jersey.config.property.packages", "net.whydah.iam.service.resource,net.whydah.iam.service.view");
